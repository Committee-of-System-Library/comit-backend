...
{주제}-convention.md ← 운영 증상에서 출발하는 코딩 컨벤션
```
...
| `transaction-boundary-convention.md` | 트랜잭션·락 구간 최소화 컨벤션(C1~C6), `@Transactional` 전수 감사 결과(L1~L6)와 처방, 리뷰 절차와 Hikari/InnoDB 검증 방법 |

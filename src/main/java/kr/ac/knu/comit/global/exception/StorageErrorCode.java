...
public enum StorageErrorCode implements ErrorCode {
    ...
    FILE_SIZE_EXCEEDED(HttpStatus.BAD_REQUEST, "/problems/storage/file-size-exceeded", "파일 크기가 허용 범위를 초과했습니다."),
    UNSUPPORTED_FILE_TYPE(HttpStatus.BAD_REQUEST, "/problems/storage/unsupported-file-type", "지원하지 않는 파일 형식입니다.");
